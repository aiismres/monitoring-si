...
function openSi() {
  window.open(
    ...
    `http://localhost:3001/monitoringsi?sechID=${sechId1}&naimsechshort=${naimSechShort3}`,
    '_blank'
  );
  // window.open(
  //   // link to create-react-app builded bundle
  //   `monitoringsibandle?sechID=${sechId1}&naimsechshort=${naimSechShort3}`,
  //   "_blank"
  // );
  //
  // window.open(
